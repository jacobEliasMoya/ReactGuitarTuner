...
const WhatsTuning = () => {
  ...
  // testing out axios for restufl API calls using axios <3
  useEffect(()=>{
    axios
  ...
  return (
    <section className='w-full text-white pb-8 md:pb-10 lg:pb-16 pt-0 text-center'>
        <div className="w-full sticky top-0 py-4 md:py-10 z-10 bg-zinc-900 border-b-[1px] border-zinc-800 after:absolute after:w-full after:h-full after:bg-white after:bg-opacity-0 after:backdrop-blur-md  after:-z-[2] bg-opacity-80 overflow-hidden after:left-0 after:top-0">
