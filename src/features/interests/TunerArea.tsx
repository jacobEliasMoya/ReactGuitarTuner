  ...
  <section className='w-full min-h-screen text-white pt-0 text-center relative flex items-start justify-between flex-col'>
    ...
    <div className="w-full flex flex-col gap-20 items-end justify-center">
      <div className="w-full mx-auto md:w-11/12 flex items-center justify-center flex-col gap-4 md:gap-6  px-8 md:px-10 lg:px-16 md:mt-20 ">
        <NoteDisplay note={"A#"} supportiveText={"Almost in Tune"} hurtz={0}/>
      </div>

      <CalibrationDisplay calibrationNeedle={15}/>
    ...
    <div className="w-full flex flex-row items-center justify-center gap-4 md:gap-8 p-4 md:p-9 lg:p-11 bg-zinc-800 border-t-[1px] border-zinc-700 after:absolute after:w-full after:h-full after:bg-white after:bg-opacity-0 after:backdrop-blur-md  after:-z-[2] bg-opacity-80 overflow-hidden after:left-0 after:!top-0 md:mt-20 text-xs md:text-md lg:text-xl font-secondary ">
      <div className="w-7 h-7 md:w-16 md:h-16 bg-zinc-500 border-2 border-zinc-600 rounded-full flex items-center justify-center">A</div>
      <div className="w-7 h-7 md:w-16 md:h-16 bg-zinc-500 border-2 border-zinc-600 rounded-full flex items-center justify-center">B</div>
      <div className="w-7 h-7 md:w-16 md:h-16 bg-zinc-500 border-2 border-zinc-600 rounded-full flex items-center justify-center">C</div>
      <div className="w-7 h-7 md:w-16 md:h-16 bg-zinc-500 border-2 border-zinc-600 rounded-full flex items-center justify-center">D</div>
      <div className="w-7 h-7 md:w-16 md:h-16 bg-zinc-500 border-2 border-zinc-600 rounded-full flex items-center justify-center">E</div>
      <div className="w-7 h-7 md:w-16 md:h-16 bg-zinc-500 border-2 border-white rounded-full flex items-center justify-center">F</div>
    </div>
