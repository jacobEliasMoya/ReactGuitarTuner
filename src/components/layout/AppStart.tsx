...
const AppStart = (props:Props) => {
  ...
  return (
    <div className={`will-change-transform md:w-96 w-64 h-64 md:h-96 [background-image:linear-gradient(45deg,#c8ffbe_0%_50%,white_50%_100%)]  flex flex-col items-center justify-center  [border-radius:15%_90%_62%_41%_/_15%_41%_62%_90%] [box-shadow:_-15em_-15em_1em_-5em_#00000026] fixed -rotate-[135deg] hover:scale-90 top-1/3 -mt-14 ${props.additionalClasses}`}>
