...
const AppStart = (props:Props) => {
  ...
  return (
    <div className={`will-change-transform md:w-96 w-64 h-64 md:h-96 bg-white -rotate-[135deg] flex flex-col items-center justify-center  [border-radius:15%_90%_62%_41%_/_15%_41%_62%_90%] [box-shadow:_-15em_-15em_1em_-5em_#00000026] relative hover:-top-2 ${props.additionalClasses}`}>
