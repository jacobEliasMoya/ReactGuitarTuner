...
const AppStart = (props:Props) => {
  ...
  return (
    <div className={` will-change-transform md:w-96 w-72 h-72 md:h-96 bg-white flex flex-col items-center justify-center  [border-radius:15%_90%_62%_41%_/_15%_41%_62%_90%] fixed -rotate-[135deg] top-1/3 -mt-14 border-2 border-zinc-900 ${props.additionalClasses}` }>
