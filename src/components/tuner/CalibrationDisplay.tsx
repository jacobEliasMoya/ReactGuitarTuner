...
const CalibrationDisplay = (props: Props) => {
  ...
  return (
      <div className="w-full mx-auto lg:w-1/2 flex flex-row items-end justify-evenly lg:justify-center lg:gap-20  bg-white p-4 md:p-8  rounded-3xl relative  overflow-hidden">
